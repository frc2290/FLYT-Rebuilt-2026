...
public class TurretConstants {
    ...
    public static final double hoodPitchCalibrationGain = -1.1296;//-0.8475;
    public static final double hoodPitchCalibrationOffset = 79.8453;//79.007;
    public static final double flywheelSpeedCalibrationGain = 0.8483;//0.5344;
    public static final double flywheelSpeedCalibrationOffset = -0.1178;//1.1015;
