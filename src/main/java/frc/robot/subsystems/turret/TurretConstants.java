...
public class TurretConstants {
    ...
    public static final ShooterParamMap HUB_MAP = new ShooterParamMap(
        Pair.of(0.0000, new FullShooterParams(6.11436862977139, 78.2710563813524, 1.03137178809258)),
        Pair.of(1.0000, new FullShooterParams(6.14192178570557, 78.2321078718026, 1.03738068851269)),
        Pair.of(1.5000, new FullShooterParams(6.73112519702398, 77.2707961884664, 1.04880119440428)),
        Pair.of(2.0000, new FullShooterParams(7.09587302623741, 73.6737549680296, 1.10129998113638)),
        Pair.of(2.5000, new FullShooterParams(7.32095472068541, 70.5373925583464, 1.14921870835429)),
        Pair.of(3.0000, new FullShooterParams(7.37796564722561, 66.7754726952878, 1.15129002258811)),
        Pair.of(3.5000, new FullShooterParams(7.77290213075926, 63.3789763923797, 1.16624293712219)),
        Pair.of(4.0000, new FullShooterParams(8.08014884108419, 61.2240788798783, 1.18091286545502)),
        Pair.of(4.5000, new FullShooterParams(8.33846403091185, 58.4598356440093, 1.19076750982767)),
        Pair.of(5.0000, new FullShooterParams(8.52597828614494, 55.4007492056919, 1.19852409213318)),
        Pair.of(5.5000, new FullShooterParams(8.81002275125144, 54.2165095155730, 1.21796395765891)),
        Pair.of(6.0000, new FullShooterParams(9.13245581209513, 51.5860185677458, 1.22690371187347)),
        Pair.of(14.0000, new FullShooterParams(14.8397152826704, 27.9329802329265, 1.29184072402952))
    );

    public static final ShooterParamMap SHUTTLE_MAP = new ShooterParamMap(
        Pair.of(1.0000, new FullShooterParams(3.733813, 70.353757, 0.820045)),
        Pair.of(1.5000, new FullShooterParams(4.439007, 67.703245, 0.926503)),
        Pair.of(2.0000, new FullShooterParams(5.080442, 66.191789, 1.025526)),
        Pair.of(2.5000, new FullShooterParams(5.681886, 65.314788, 1.120516)),
        Pair.of(3.0000, new FullShooterParams(6.202885, 64.335025, 1.200103)),
        Pair.of(3.5000, new FullShooterParams(6.693418, 63.552581, 1.275000)),
        Pair.of(4.0000, new FullShooterParams(7.100870, 62.380226, 1.331092)),
        Pair.of(4.5000, new FullShooterParams(7.486399, 61.297752, 1.382833)),
        Pair.of(5.0000, new FullShooterParams(7.804552, 59.814176, 1.417331)),
        Pair.of(5.5000, new FullShooterParams(8.111135, 58.387945, 1.448561)),
        Pair.of(6.0000, new FullShooterParams(8.377355, 56.663147, 1.467243)),
        Pair.of(6.5000, new FullShooterParams(8.642164, 54.991262, 1.483944)),
        Pair.of(7.0000, new FullShooterParams(8.891982, 53.160483, 1.493316)),
        Pair.of(7.5000, new FullShooterParams(9.147452, 51.391559, 1.501749)),
        Pair.of(8.0000, new FullShooterParams(9.403778, 49.583392, 1.506779)),
        Pair.of(8.5000, new FullShooterParams(9.668963, 47.846504, 1.511497)),
        Pair.of(9.0000, new FullShooterParams(9.941604, 46.141911, 1.515006)),
        Pair.of(9.5000, new FullShooterParams(10.223680, 44.511431, 1.518485)),
        Pair.of(10.0000, new FullShooterParams(10.514643, 42.941886, 1.521684)),
        Pair.of(10.5000, new FullShooterParams(10.814504, 41.443072, 1.524938)),
        Pair.of(11.0000, new FullShooterParams(11.122853, 40.009851, 1.528203)),
        Pair.of(11.5000, new FullShooterParams(11.439309, 38.643092, 1.531586)),
        Pair.of(12.0000, new FullShooterParams(11.763453, 37.339282, 1.535081)),
        Pair.of(12.5000, new FullShooterParams(12.094884, 36.095546, 1.538699)),
        Pair.of(13.0000, new FullShooterParams(12.433209, 34.909118, 1.542449)),
        Pair.of(13.5000, new FullShooterParams(12.778068, 33.776872, 1.546332)),
        Pair.of(14.0000, new FullShooterParams(13.129125, 32.695801, 1.550345)),
        Pair.of(14.5000, new FullShooterParams(13.486066, 31.663028, 1.554488)),
        Pair.of(15.0000, new FullShooterParams(13.848600, 30.675814, 1.558758)),
        Pair.of(15.5000, new FullShooterParams(14.216455, 29.731555, 1.563155)),
        Pair.of(16.0000, new FullShooterParams(14.589381, 28.827790, 1.567677)),
        Pair.of(16.5000, new FullShooterParams(14.967143, 27.962192, 1.572322)),
        Pair.of(17.0000, new FullShooterParams(15.349524, 27.132568, 1.577089)),
        Pair.of(17.5000, new FullShooterParams(15.736325, 26.336854, 1.581977)),
        Pair.of(18.0000, new FullShooterParams(16.127357, 25.573109, 1.586983)),
        Pair.of(18.5000, new FullShooterParams(16.522449, 24.839511, 1.592106)),
        Pair.of(19.0000, new FullShooterParams(16.921441, 24.134350, 1.597345)),
        Pair.of(19.5000, new FullShooterParams(17.324186, 23.456020, 1.602698)),
        Pair.of(20.0000, new FullShooterParams(17.730547, 22.803017, 1.608162))
    );
