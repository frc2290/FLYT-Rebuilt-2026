...
/**
 * Generates a trajectory on the fly and feeds it to the pose estimator one
 * sample at a time.
 */
public class SwerveAutoStep extends Command {
    ...
    /**
     * Creates a command that streams trajectory samples to the drive subsystem
     * using the current
    ...
    public void execute() {
        ...
        // Provide the desired pose to the drive state machine so it can follow the
        // path.
    ...
    public void end(boolean interrupted) {
        ...
        // Snap to the final pose to avoid drift if the drive command was interrupted
        // early.
