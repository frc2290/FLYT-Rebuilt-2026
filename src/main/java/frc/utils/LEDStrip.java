...
public class LEDStrip {
  ...
  /** Ending index (inclusive) in the master LED buffer. */
  int stop;
  ...
  /** Optional pattern override that bypasses the legacy effect enum. */
  LEDPattern patternOverride = null;
  ...
  public LEDPattern getPattern() {
    ...
    return LEDEffects.patternFor(effect, this);
  }
  ...
  public void clearPatternOverride() {
